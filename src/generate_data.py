...
def generate_logistics_data(num_records):
    ...
    for _ in range(num_records):
        ...
        logistics_entry = {
            ...
            "timestart": (datetime.now() + timedelta(hours=fake.random_int(min=0, max=230)) - timedelta(hours=fake.random_int(min=0, max=230*2)) - timedelta(minutes=fake.random_int(min=1, max=60))).isoformat(),
            "p_price": p_price,
